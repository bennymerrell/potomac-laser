// Body class for Elementor-built Services/Applications pages.
...
add_action( 'wp_head', function () {
    $is_cls = is_singular( array( 'post_services', 'post_application' ) ) && get_post_meta( get_queried_object_id(), '_elementor_edit_mode', true ) === 'builder';
    ...
    if ( $is_cls ) {
        echo '.cnc-elementor-fullbleed{overflow-x:hidden;}'
            ...
            . '.cnc-elementor-fullbleed .e-con-inner{max-width:1224px!important;}'
